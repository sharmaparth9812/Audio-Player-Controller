...
uint16_t CAmpMeter::_getBarPattern(float data) {
	uint16_t pattern = 0;
	/*
	 * Calculate the appropriate bar pattern (pattern) for the absolute value of data.
	 ...
	 * (peak normalization).
	 */
	//  bar pattern generation is here
	if(m_scmode==SCALING_MODE_LOG){
